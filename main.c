...
//function to aquire a valid input from the user.
//Restricts user to decimal values.
int takeinput()
{
        while(1)
        {      
...
int main()
{
	//flag to avoid double memory release during exit
	exit_flag = 0;
	...
	while(1)
	{
		...
		{
			//string compare to invoke a particular called function by user
		...
		//handling out of bound commands
